...
/// tracks/faces-only bundle frame (change-driven, ~15 Hz cap) — the video
/// relay frames carry no track payload anymore
pub const TRACKS_DATA_TYPE: &str = "application/x-neomind-tracks";
