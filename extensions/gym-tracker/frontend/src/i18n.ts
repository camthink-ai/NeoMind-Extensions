...
const zh = {
  ...
  loadSummaryFail: '加载概况失败', retryBtn: '重试', loadingDots: '加载中…',
  prevDay: '前一天', nextDay: '后一天',
  markHandled: '标记已处理/误报',
  weekdayShort: '周X',
  memberNamePh: '会员姓名', enterToSave: '回车也可保存',
  mergeIntoPh: '并入哪位会员？', recordsLoading: '记录加载中…',
  legendTrails: '蓝线 = 最近轨迹',
...
const en: Partial<Dict> = {
  ...
  loadSummaryFail: 'Failed to load summary', retryBtn: 'Retry', loadingDots: 'Loading…',
  prevDay: 'Previous day', nextDay: 'Next day',
  markHandled: 'Mark handled / false positive',
  weekdayShort: '',
  memberNamePh: 'Member name', enterToSave: 'Enter also saves',
  mergeIntoPh: 'Merge into which member?', recordsLoading: 'Loading records…',
  legendTrails: 'Blue line = recent trail',
