...
- `dist/yolo-video-components.umd.js` - UMD bundle for dashboard
...
**Props:**
- `title` - Component title (default: "YOLO Video")
...
```tsx
import { YoloVideoDisplay } from '@neomind/yolo-video-frontend'

<YoloVideoDisplay
  dataSource={{ extensionId: 'yolo-video' }}
  sourceUrl="camera://0"
