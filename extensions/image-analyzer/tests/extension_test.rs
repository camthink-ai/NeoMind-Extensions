...
mod tests {
    ...
    use neomind_extension_image_analyzer::{ImageAnalyzer, Detection, BoundingBox, AnalysisResult};
    ...
    fn test_metadata_basic() {
        ...
        assert_eq!(meta.id, "image-analyzer");
        assert_eq!(meta.name, "Image Analyzer");
