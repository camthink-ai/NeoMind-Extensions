...
A weather data extension for the NeoMind Edge AI Platform.
...
The extension will be auto-discovered on next startup.
...
See [EXTENSION_GUIDE.md](EXTENSION_GUIDE.md) for details on developing your own extensions.
